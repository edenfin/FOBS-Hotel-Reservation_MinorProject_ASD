...
if($em == $passw){
// select values
        echo "<h8>That Email<br>is already taken :( </h8><br><br>";
        $link = "User_info.php";
...
$sql = "insert into customers values
        ('$fn','$ln','$ci','$co','$room','$price','$maxres','$em','$pw')";
if ($conn->query($sql) === TRUE) {
        echo "<h8>Thanks for choosing us, we hope to serve you soon</h8>";
        $link = "Login.php";
        print "<a href='".$link."'><h6><br>You can view once again your reservation info if you login here</h6></a>";
} else {
    echo "Error creating database: " . $conn->error;
}
}       
